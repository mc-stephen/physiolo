    ...
    <section className={Style.bottomHeader}>
      <div className={Style.logo}>
        {/* <Image
          ...
          src="http://physiolo.de/wp-content/uploads/2023/04/physio-logo.png"
          alt="logo"
        /> */}
      </div>
                ...
                <li className={Style.dropDownMenuItem}>
                  ...
                  <div className={Style.subDropDownMenu}>
                    <ul className={Style.subDropDownMenuItems}>
                      <li className={Style.subDropDownMenuItem}>
                        <a href="#">UBER UNS</a>
                      </li>
                      <li className={Style.subDropDownMenuItem}>
                        <a href="#">TEAM</a>
          ...
          <li className={Style.navItem}>
            ...
            <div className={Style.dropDownMenu}>
              <ul
                ...
                id={Style.dropDownMenuItem2}
              >
                <li className={Style.dropDownMenuItem}>
                  <a href="#">KG ZNS, PNF/BOBATH</a>
                </li>
                <li className={Style.dropDownMenuItem}>
                  <a href="#">KRANKENGYMNASTIK</a>
                </li>
                <li className={Style.dropDownMenuItem}>
                  <a href="#">MANUELLE LYMPHDRAINAGE</a>
                </li>
                <li className={Style.dropDownMenuItem}>
                  <a href="#">MASSAGEN</a>
                </li>
                ...
                <li className={Style.dropDownMenuItem}>
                  <a href="#">AUFBAU UND TRAINING VON SPORTLERN</a>
                </li>
                <li className={Style.dropDownMenuItem}>
                  <a href="#">KÄLTE / KRYOTHERAPIE</a>
                </li>
                <li className={Style.dropDownMenuItem}>
                  <a href="#">WÄRMETHERAPIE</a>
                </li>
                <li className={Style.dropDownMenuItem}>
                  <a href="#">SPORTTHERAPIE</a>
                </li>
                <li className={Style.dropDownMenuItem}>
