        ...
        <div className={styles.servicesContainer}>
          ...
          <div className={styles.servicesBoxContainer}>
            <div className={styles.servicesBox}>
              <span className={styles.servicesIcon}><Image src={homeIcon1} alt={"home Icon"} className={styles.homeIcon}/></span>
              <h5 className={styles.servicesTitle}>KG-KNS-PNF/BOBATH</h5>
              <p className={styles.servicesContent}>Multiple sclerosis, {"Parkinson's"} disease, paraplegia, traumatic brain injury, stroke, joint surgery, 
                sports accidents, facial, oral and swallowing problems (including jaw problems), back pain</p>
              <button type="button" className={styles.servicesButton}>Learn more</button>
            </div>
            <div className={styles.servicesBox}>
              <span className={styles.servicesIcon}><Image src={homeIcon2} alt={"home Icon"} className={styles.homeIcon}/></span>
              <h5 className={styles.servicesTitle}>PHYSIOTHERAPY</h5>
              <p className={styles.servicesContent}>Fractures, use of artificial joints, amputations, muscle and tendon tears, strengthening and stabilization of patients,
                treatment after accidents or long-term illnesses, reintegration into work, osteoarthritis, spinal diseases</p>
              <button type="button" className={styles.servicesButton}>Learn more</button>
            </div>
            <div className={styles.servicesBox}>
              <span className={styles.servicesIcon}><Image src={homeIcon3} alt={"home Icon"} className={styles.homeIcon}/></span>
              <h5 className={styles.servicesTitle}>Manual lymph drainage</h5>
              <p className={styles.servicesContent}>Chronic, lymphedema, chronic venous insufficiency, postoperative swelling, torn muscle fibers, chronic polyarthritis, 
                CRPS (complex regional pain syndrome), post-stroke hemiplegia swelling, headache</p>
              <button type="button" className={styles.servicesButton}>Learn More</button>
            </div>
          </div>
          <div className={styles.buttonBox}>
            <button type="button" className={styles.moreServicesButton}>View More Services</button>
          </div>
        </div>
      </section>
